...
class ExpiringProduct(Product):
    def __init__(self, name, category_name, unit_price, production_year, validiti_years):
        super().__init__(name, category_name, unit_price)
        self.production_year = production_year
        self.validiti_years = validiti_years

    def does_expire(self, currently_years):
        return currently_years > self.production_year + self.validiti_years
